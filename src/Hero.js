    ...
    <section id="hero" className="min-h-screen bg-center bg-no-repeat bg-cover">
      <div className="container flex items-center">
        ...
        <h2 className="text-2xl xl:text-4xl font-bold">The Interoperable Entropy Layer</h2>
          <p>The IDN enables interoperable randomness beacons, producing publicly verifiable on-chain randomenss that can be use in trustless, on-chain protocols.</p>
