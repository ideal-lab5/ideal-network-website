...
const teamMembers = [
  {
    ...
    bio: "Former VP of Engineering at Coinbase. Led blockchain infrastructure teams scaling to millions of users. PhD in Computer Science from MIT.",
  ...
  },
  {
    ...
    bio: "Previously Senior Engineer at Parity Technologies. Core contributor to Substrate and Polkadot ecosystem. 8+ years in blockchain development.",
    image: "/api/placeholder/300/300", // Replace with actual image path
  ...
  },
  {
    ...
    bio: "Former cryptography researcher at Protocol Labs. Published 15+ papers on zero-knowledge proofs and consensus mechanisms. PhD from Stanford.",
    image: "/api/placeholder/300/300", // Replace with actual image path
  ...
  },
  {
    ...
    bio: "Product leader with 10+ years at Google and Meta. Shipped products used by billions. Expert in developer experience and API design.",
    image: "/api/placeholder/300/300", // Replace with actual image path
      ...
      <div className="container-max">
        ...
        >
          ...
          <p className="text-xl text-text-secondary max-w-2xl mx-auto">
            Experienced leaders building the future of decentralized infrastructure
          </p>
        </motion.div>
